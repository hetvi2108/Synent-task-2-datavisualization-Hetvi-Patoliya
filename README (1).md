...
> **A structured, visual EDA of the Fisher Iris dataset using Python**
> Analysing 150 specimens across 3 species and 4 morphological features.
...
- [Feature Priority for Modelling](#-feature-priority-for-modelling)
...
1. Which species are easy to separate and which are difficult?
2. Which features carry the most discriminative information?
3. What is the best strategy for building a classification model?
